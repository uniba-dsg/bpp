...
class ExtensionAssertions {
	...
	private TestAssertion createR39() {
		...
		assertion
				.addContainedFileLocations("src/main/resources/language-features/basic-activities/NonBPELNamespace.bpel");
		assertion
				.setTarget("//*[local-name() = 'process' and not(namespace-uri() = 'http://docs.oasis-open.org/wsbpel/2.0/process/executable')]");
		assertion
				.setDiagnosticMessage("The process definition does not use the http://docs.oasis-open.org/wsbpel/2.0/process/executable namespace");
	...
	private TestAssertion createR40() {
		...
		assertion
				.addContainedFileLocations("src/main/resources/language-features/basic-activities/NonBPELElement.bpel");
		assertion
		...
		assertion
				.setTarget("//*[not(ancestor::*[local-name() = 'literal']) and not(local-name() ='process') and not(local-name() = 'import') and not(local-name() = 'partnerLinks') "
